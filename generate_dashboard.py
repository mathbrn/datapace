...
function updateTrends(){
  ...
  },plugins:{legend:{display:false},tooltip:{backgroundColor:mkTT().backgroundColor,borderColor:mkTT().borderColor,borderWidth:1,titleColor:mkTT().titleColor,bodyColor:mkTT().bodyColor,padding:12,callbacks:{title:function(items){return items.length?items[0].dataset.label:'';},label:function(ctx){
    ...
    window._cmpChart=new Chart(cc,{type:'line',
      ...
      options:{responsive:true,maintainAspectRatio:false,
        plugins:{legend:{display:true,labels:{color:mkTICK().color,font:{size:11},usePointStyle:true,pointStyle:'line',boxWidth:20}},
          tooltip:{backgroundColor:mkTT().backgroundColor,borderColor:mkTT().borderColor,borderWidth:1,titleColor:mkTT().titleColor,bodyColor:mkTT().bodyColor,padding:10,callbacks:{label:function(ctx){return' '+ctx.dataset.label+': '+fmtFull(ctx.parsed.y);}}}},
