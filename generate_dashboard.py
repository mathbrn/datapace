...
function buildOvSponsoring(eventName,eventColor){
  ...
  var tConf={
    title:{label:'TITRE',border:ec,text:'#fff',bg:ec+'26'},
    premium:{label:'PREMIUM',border:ec+'B3',text:ecLight,bg:ec+'1F'},
    major:{label:'MAJEUR',border:ec+'B3',text:ecLight,bg:ec+'1F'},
    official:{label:'OFFICIEL',border:ec+'80',text:ec,bg:ec+'14'},
    partner:{label:'FOURNISSEUR',border:'#ffffff25',text:'#888',bg:'transparent'}
  };
