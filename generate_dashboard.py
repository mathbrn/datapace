...
function mkTT(cb){var lt=isLight();var o={backgroundColor:lt?'#ffffff':'#1a1a1a',borderColor:lt?'rgba(0,0,0,0.08)':'rgba(255,255,255,0.08)',borderWidth:1,titleColor:'#888',bodyColor:lt?'#0a0a0a':'#f0f0f0',padding:12,cornerRadius:6,displayColors:true,boxWidth:8,boxHeight:8,boxPadding:4,titleFont:{size:10,family:'Inter',weight:'400'},bodyFont:{size:13,family:'Inter',weight:'500'}};if(cb)o.callbacks=cb;return o;}
